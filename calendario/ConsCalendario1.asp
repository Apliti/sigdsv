...
'response.Write("DATAINICIAL = " & Request.Form("DATAINICIAL"))
'response.Write("DATAFINAL = " & Request.Form("DATAFINAL"))
'response.End()
...
End If
If Request.Form("DATAFINAL") <> "" Then
	str_DATA_FINAL = Year(CDate(Request.Form("DATAFINAL"))) & "," & Month(CDate(Request.Form("DATAFINAL")))-1 & "," & Day(CDate(Request.Form("DATAFINAL")))
Else
...
function buildBottomCalFrame(){
	...
	//alert('sResultado >= nResultado = ' + sResultado + ' - ' + nResultado)
	//alert(sResultado >= nResultado)
	//alert('sResultado >= fResultado = ' + sResultado + ' - ' + fResultado)
	//alert(sResultado >= fResultado)
	//alert('sResultado >= nResultado = ' + sResultado >= nResultado)
	
	exibirData = "SIM";	
	if(sResultado < nResultado && sResultado > fResultado)
    	{
		exibirData = "NÃO";	
		}
